...
configuration = {
    ...
    "components": {
        "water": {# 1.1) Type of chemical specie 
                  ...
                  # Heat capacity, molar enthalpy, molar entropy and saturation pressure for vapor ==> from NIST module
                  #"cp_mol_ig_comp": NIST,
                  ...
                  "parameter_data": {
                  # Molecular weight
                                     "mw": (18.015E-3, pyunits.kg/pyunits.mol),  # Reference [1] p A.18
                  # Critical Pressure
                                     "pressure_crit": (220.64e5, pyunits.Pa),  # Reference [1] p A.18
                  # Critical Temperature
                                     "temperature_crit": (647.14, pyunits.K),  # Reference [1] p A.18
                  # Parameters for heat capacity, molar enthalpy, molar entropy and saturation pressure for vapor ==> from NIST website
                                     "cp_mol_ig_comp_coeff": {# Range of temperature 500-1700 K. Reference [4]
                                                              ...
                                                              'F': (-250.881, pyunits.kJ/pyunits.mol),
                                                              'G': (223.3967, pyunits.J/pyunits.mol/pyunits.K),
                                                              'H': (-241.8264, pyunits.kJ/pyunits.mol)
                                                              },
                                     "pressure_sat_comp_coeff": {# Range of temperature 255.9-373 K. Reference [4]
                                                              'A': (4.6543, None),
        ...
        "ethanol": {# 1.1) Type of chemical specie 
                    ...
                    # Parameters for heat capacity, molar enthalpy, molar entropy and saturation pressure for vapor ==> from RPP
                                       ...
                                       "pressure_sat_comp_coeff": {# Range of temperature 293-() K. Reference [1] 3rd Ed. p 678
                                                                'A': (-8.51838, None),  
                                                                'B': (0.34163, None),
                                                                'C': (-5.73683, None),
                                                                'D': (8.32581, None)
    ...
    # 4.2) State bounds
    "state_bounds": {"flow_mol_phase_comp": (0, 10, 100, pyunits.mol/pyunits.s),
